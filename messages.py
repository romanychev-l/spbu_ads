command_start = 'Для бота доступны следующие команды:\n\
...
command_add = 'В следующем сообщении отправьте мне список тегов, на которые хотите подписаться. \
Формат сообщения должен быть таким:\ntag1 tag2 tag3'

command_del = 'В следующем сообщении отправьте мне список тегов, от которых хотите отписаться. \
Формат сообщения должен быть таким:\ntag1 tag2 tag3'
...
not_username = 'Я не вижу Ваш username. Без него нет смысла выкладывать Ваше объявление. \
Проверьте настройки приватности.'

command_new_post_1 = 'Отправьте мне текст Вашего обьявления.\n\
...
command_new_post_2 = 'Отлично! Теперь пришлите мне фотографии. \
...
main_logic_2 = 'Начать любое заимодействие с ботом можно через команды.\n\
